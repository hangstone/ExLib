...
REM -- COPY libraries
XCOPY "%SRC_DBG_x86_DIR%\zlib_d.lib"	%LIB_DEST_x86_DIR%%LIBDIR% %COPYOPT%
XCOPY "%SRC_REL_x86_DIR%\zlib_o.lib"	%LIB_DEST_x86_DIR%%LIBDIR% %COPYOPT%
XCOPY "%SRC_DBG_x64_DIR%\zlib_d.lib"	%LIB_DEST_x64_DIR%%LIBDIR% %COPYOPT%
XCOPY "%SRC_REL_x64_DIR%\zlib_o.lib"	%LIB_DEST_x64_DIR%%LIBDIR% %COPYOPT%
